...
public class OreDictManager {
    public static void registerEntries() {
        for(EnumPurifiableMineral i : EnumPurifiableMineral.values()) {
            OreDictionary.registerOre("dust" + i.getOreDictSuffix(), new ItemStack(ModItems.powder, 1, i.getOrdinal()));
        }
    }
    ...
    public static void registerRecipes() {
        for(EnumPurifiableMineral el : EnumPurifiableMineral.values()) {
            ...
            for (ItemStack i : OreDictionary.getOres("dust" + el.getOreDictSuffix())) {
                ...
                RecipeHandler.addRecipe(TilePurifier.class, entry, new MachineRecipeComponent(new ItemStack(ModItems.purifiedPowder, 1, el.getOrdinal())));
            }
        }
    }
}
